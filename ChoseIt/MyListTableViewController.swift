...
class MyListTableViewController: UITableViewController {
    ...
    private func loadDefaults() {
        ...
        guard let default1 = ChoseList(name: "Restaurants", photo: photo1, list: []) else {
            fatalError("Unable to instantiate default1")
        }
        
        guard let default2 = ChoseList(name: "Movies & Shows", photo: photo2, list: []) else {
            fatalError("Unable to instantiate default2")
        }
        
        guard let default3 = ChoseList(name: "Food Recipes", photo: photo3, list: []) else {
            fatalError("Unable to instantiate default1")
        }
